...
export const transactions: Transaction[] = [
  { id: 'tx1', date: '2026-05-25', type: 'earned', amount: 500, status: 'completed', description: 'Portfolio Website Task' },
  { id: 'tx2', date: '2026-05-24', type: 'escrow', amount: 400, status: 'pending', description: 'Graphic Design Task' },
  { id: 'tx3', date: '2026-05-23', type: 'deposit', amount: 1000, status: 'completed', description: 'bKash Deposit' },
  { id: 'tx4', date: '2026-05-22', type: 'earned', amount: 300, status: 'completed', description: 'Data Entry Task' },
  { id: 'tx5', date: '2026-05-21', type: 'withdraw', amount: 500, status: 'completed', description: 'bKash Withdraw' },
  { id: 'tx6', date: '2026-05-20', type: 'escrow', amount: 400, status: 'pending', description: 'Poster Design Escrow' },
  { id: 'tx7', date: '2026-05-19', type: 'earned', amount: 250, status: 'completed', description: 'App Testing Task' },
]
